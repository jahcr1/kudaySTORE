    ...
    <section id="cartucheras" style="margin-top: 20px; padding: 20px 0 20px 0;" class="img-fluid">
        ...
        <div class="container text-center" style="margin-top: 50px;">
            <div class=" row m-1">
                ...
                $consultar_productos = mysqli_query($conexion, "SELECT * FROM productos WHERE categoria = 'Cartuchera'");
                    ...
                    <div class="listas">
                        <div class="col-md-3 m-2 contenedor-foto align-self-center">
                            <?php if (!empty($listar_productos['ci_imagen_producto'])): ?>
                                ...
                                echo "<img src='data:$img_type;base64,$img_data' class='imagen-render' alt='Imagen del producto'>";
                                ?>
                            <?php else: ?>
                        ...
                        <div class="card contenedor-detalle m-2">
                            <div class="card-body card-body-tienda ">
                                ...
                                <p class="text-start p-2"><span style="font-weight: bold;">Articulo: </span><span class="dato"><?php echo $listar_productos['categoria']; ?></span></p>
