...
<head>
    ...
    <title>Billeteras Kuday | Sitio Oficial</title>
...
<body class="cartuchera-body">
            ...
            <div class="container-fluid" style="flex-wrap: wrap;">
                    ...
                    <div class="collapse navbar-collapse" id="navbarScroll">
                        <ul class="navbar-nav ms-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 620px; margin-right:50px;">
                            <li class="nav-item">
                                <a class="nav-link active boton-nav" href="billeteras.php#vistas-inicio">Inicio</a>
                            </li>
    ...
    <section id="vistas-inicio" style="margin-top:20px; padding:20px 0 20px 0;">
        ...
        <div class="container contenedor-h3">
            <h3 class="text-center titulo-categoria" style="margin-top: 80px;">Billeteras</h3>
        </div>

        <div style="margin-top: 50px;">
            <div class="grid-container">
                <!-- ACA LISTAMOS SOLO LAS BILLETERAS DESDE LA BD -->
                <?php
                include('../componentes/conexion.php');
                $consultar_productos = mysqli_query($conexion, "SELECT p.*, c.nombre AS categoria_nombre FROM productos p JOIN categorias c ON p.categoria_id = c.id WHERE p.categoria_id = '5'");
