...
<div class="row contenedor_footer">  
    <div class="col-xl-3 col-md-3 col-sm-10 p-2">
        <h6 class="h6-footer"><i class="bi bi-tencent-qq" style="font-size: 30px;"></i>  CONTÁCTANOS</h6>
        <p class="p-footer" style="font-size:14px;"><i class="bi bi-telephone-fill"></i>   +54 9 0297 432-1429</p>
        <p class="p-footer" style="font-size:14px;"><i class="bi bi-whatsapp"></i>   +54 9 0297 432-1429</p>
        <p class="p-footer" style="font-size:14px;"><i class="bi bi-geo-alt-fill"></i>   Gral. Araóz de Lamadrid 425</p>
    </div>
